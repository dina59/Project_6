...
loaded_model=pickle.load(open('C:/Users/Acer/project/pages/KNN.sav','rb'))
...
def main():
 ...
 st.markdown("""
   <div class="css-h5rgaw e1g8pov61" >
         <p style='text-align: right;'>WE ARE HERE TO SOLVE PROBLEMS</P>
    </div>    
